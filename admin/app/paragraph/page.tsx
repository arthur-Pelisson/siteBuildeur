...
const PageParagraphe = () => {
    const [posts, setPosts] = useState(null);
    const { response: respost, Error: errpost, Loading: loadpost, Success: successpost } = getPostByType("text");
    const {
        response: resdelete,
        Error: errdelete,
        Loading: loaddelete,
    ...
    useEffect(() => {
        if (successdelete && !loaddelete) {
            setSnackBar({ open: true, message: "Paragraphe suprimmé avec succès", type: "success" });
        ...
        if (errdelete && !loaddelete) {
            setSnackBar({ open: true, message: "Erreur lors de la supression du paragraphe", type: "error" });
            setItemToDelete({ id: 0, title: "" });
        }
    ...
    useEffect(() => {
        if (successpublish && !loadpublish) {
            ...
            if (itemToPublish?.published) {
                message = "Pragraphe dépuplier avec succès";
            } else {
                message = "Paragraphe publier avec succès";
            }
        ...
        if (errpublish && !loadpublish) {
            setSnackBar({ open: true, message: "Erreur lors de la publication du paragraphe", type: "error" });
            setItemToPublish({ id: 0, title: "", published: false });
        }
    ...
    const handlePublish = (IDitemToPublish: number, titleItem: string, published: boolean) => {
        ...
        FpublishPost({ url: `${publishParams.url}text/publishe/${IDitemToPublish}`, method: publishParams.method });
    };
    ...
    const handleConfirmDeleteMedia = async (response: boolean) => {
        ...
        FdeletePost({ url: `${deleteParams.url}text/${itemToDelete.id}`, method: deleteParams.method });
    };
    ...
    return (
        <div className="text-center">
            ...
            />
            <h1 className="text-4xl mb-3 underline">Paragraphe</h1>
            <div className="flex flex-col justify-center items-center">
                <div className="w-[100%] text-center mb-4">
                    <Button className="!m-auto " variant="contained" href="/paragraph/create">
                        ...
                        <DataGrid
                            ...
                            columns={[
                                { field: "id", headerName: "ID", width: 130 },
                                {
                                    ...
                                    headerAlign: "center",
                                    align: "center",
                                    description: "Nom unique de l'article",
                                },
                                {
                                    field: "title",
                                    headerName: "Titre",
                                ...
                                },
                                {
                                    ...
                                    headerAlign: "center",
                                    align: "center",
                                    description: "Si le paragraphe est publié ou non",
                                    renderCell: (params: GridValueGetterParams) => {
                                ...
                                },
                                {
                                    ...
                                    headerName: "Crée",
                                    width: 250,
                                    description: "Date de création du paragraphe",
                                    renderCell: (params: GridValueGetterParams) => {
                                ...
                                },
                                {
                                    ...
                                    headerName: "Modifié",
                                    width: 250,
                                    description: "Date de modification du paragraphe",
                                    renderCell: (params: GridValueGetterParams) => {
                                ...
                                },
                                {
                                    ...
                                    width: 250,
                                    headerAlign: "center",
                                    description: "Action possible sur le paragraphe",
                                    align: "center",
                                    minWidth: 400,
                                    renderCell: (params: GridValueGetterParams) => (
                                        <div className="flex flex-row">
                                            <Tooltip title="Modifier cet élément" placement="top">
                                                <Button
                                                    ...
                                                    variant="contained"
                                                    href={`/paragraph/edit?slug=${params.row.slug}`}
                                                >
                                                    <EditIcon />
                                                </Button>
                                            </Tooltip>
                                            ...
                                            <Divider className="m-2 h-5" orientation="vertical" />
                                            <Tooltip title="Publier/Dépublier" placement="top">
                                                <Button
                                                    disabled={loaddelete ? true : false || loadpublish ? true : false}
                                                    color="info"
                                                    variant="contained"
