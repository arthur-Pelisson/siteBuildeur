...
const CreateParagraphePage = () => {
    ...
    const handleSubmite = () => {
        ...
        fetchCreatePost({ url: paramsCpost.url + "text", data: post, method: paramsCpost.method });
    ...
    return (
        <div>
            ...
            <h1 className="text-center text-3xl underline">Création de paragraphe</h1>
...
export default CreateParagraphePage;
