...
import SnackBar, {TtypeSnackB} from "@/components/snackBar";
import Loading from "@/components/loading";
import {form, formPassword, formTranslate} from "./form";
...
const Profile = () => {
    ...
    const [snack, setSnack] = useState<any>({open: false, message: "", type: ""});
  ...
  const displayAlert = () => {
    ...
    if (successUpdate || successUpdatePassword) {
        type = "success"
        message = responseUpdate?.[language] || responseUpdatePassword?.[language] || "";
        return createSnackBar(type, message);
    }
  };
